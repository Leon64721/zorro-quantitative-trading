...
hours](date.htm) (by default, 9:30 am until 16:00 pm) of a given working day and time zone.
...
- During the [LookBack](nhistory.htm) period all day price functions
	return **0**.

- The [BarPeriod](barperiod.htm) matters for precision. F.i. for a time precision of 30 minutes, use a **BarPeriod**
...
- Time travel attempts - for instance requesting today's high, low, or close price
	...
	warning when the [PEEK](mode.htm) flag is not set.

- Market hours can be changed through the global variables **
	[StartMarket](date.htm)** (default: **930**)
	and **[EndMarket](date.htm)** (default: **1600**)
	in the **hhmm** format. If the hours don't matter, use alternatively
	the [price](price.htm) functions from daily bars, or the
	[HH](ta.htm) / [LL](ta.htm) functions. Daily bars change
...
[price](price.htm), [timeOffset](month.htm),
[market](month.htm), [BarMode](barmode.htm),
[Pivot](ta.htm#pivot), [Support/Resistance](ta.htm)
