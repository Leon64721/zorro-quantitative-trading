...
**Horizon**. The minimum length of the **Data**
...
### Parameters:
             ...
             | **Data**
		     |  A data [series](series.htm), usually from price functions **[price(), priceClose()](price.htm)**, 


             | **Length**
             | The length of the data series, normally the [LookBack](lookback.htm) period.
...
- Use [plotDay](profile.htm), [
				plotWeek](profile.htm), [plotMonth](profile.htm), or
				[plotYear](profile.htm) for displaying seasonal
				dependence in a histogram.
