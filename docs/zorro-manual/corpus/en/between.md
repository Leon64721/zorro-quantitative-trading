...
## between(var x, var lower, var upper): bool
		...
		Returns **true** when the variable **x** lies
at or within a **lower** and **upper** border. When **lower** is above **upper**, returns **true** when either **x >= upper** or **x <= lower**, this way allowing the comparison of cyclic ranges such as hours of the day or months of the year.
