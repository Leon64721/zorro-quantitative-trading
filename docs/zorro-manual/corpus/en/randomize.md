...
### Parameters:
     ...
     |  
     | **DETREND**
     | Detrend the  data before randomizing, by subtracting the mean data difference.


     | **Out**
     | Array to be filled with the randomized data, or **In**
...
- This function can be used for generating randomized return distributions f.i. for White's Reality Check.
  ...
  [Lehmer algorithm](https://en.wikipedia.org/wiki/Lehmer_random_number_generator) with a period of
  2,147,483,646.
...
[Detrend](detrend.htm), [random](random.htm)
