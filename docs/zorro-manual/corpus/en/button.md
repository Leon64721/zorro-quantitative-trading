...
 
		 ...
		 | **8**
		 | Single Step (see [debugging](chart.htm))


		 | **10**
		 | Replay (see [debugging](chart.htm))
...
- By setting [TESTNOW](mode.htm), the script can perform a
  **[Test](is.htm)** run even when running in [Train]
  mode (**Button == 3**).
...
[Command line](command.htm), [visual debugger](chart.htm),
[Test](is.htm), [Train](is.htm)
