...
- Bugs in expressions - for instance, division by zero - generate
	  results that are not a number (**NaN**). They are printed
	  like **"1.#J"** or **"1.#IND"**. If you see such
	  a number in the log, there's a faulty expression somewhere in your script.
