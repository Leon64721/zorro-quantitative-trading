...
User-supplied function that is called at the end of a simulation or session. Can
be used to copy files, [free memory](sys_malloc.htm), or release other allocated
resources**.
...
- All [trade statistics](winloss.htm) and [strategy statistics](statistics.htm) are  available
		  in the **evaluate** function. The **...Long/...Short** statistics parameters are for the last selected asset and algo.
