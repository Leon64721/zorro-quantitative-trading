...
several components. Between the corner points the included components donât
...
- For calculating the returns of portfolio components with currently zero
	weight in real time, use [phantom trades](lots.htm#phantom).
...
- Applications of the **markowitz** function are described in
	...
	[
	Get Rich Slowly](http://www.financial-hacker.com/get-rich-slowly/).

- The [Z8 and Z10 trading systems](zsystems.htm) use this
	function for calculating optimal portfolio compositions. For other ways of
	allocating capital, see the [OptimalF](optimalf.htm), [
	distribute](renorm.htm), and [knapsack](renorm.htm) algorithms.
...
[OptimalF](optimalf.htm), [Covariance](ta.htm),
[distribute](renorm.htm), [knapsack](renorm.htm)
