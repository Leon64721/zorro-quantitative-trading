...
# Pointers
	    ...
	    alternative names for single variables or for arrays of variables.
...
### Arrays of pointers or series
    	...
    	When accessing elements in an array of pointers or [
		series](series.htm), parentheses must be used:
...
```
	    ...
	    For storing arrays of function pointers in C,** void*** arrays can be used.
	    Example:
