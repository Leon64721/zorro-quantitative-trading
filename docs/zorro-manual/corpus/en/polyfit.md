...
of the form ***y = a******n***x***n****** +
... + a******1******x + a******0***  that is the best fit to a section of a price series or any other data series. This polynomial can be used for extrapolating the **Data** series into the future, and thus predicting future prices.
...
### Parameters:
			...
			***a******n***, or **0** for storing the coefficients internally.
			...
			(quadratic) regression, and higher numbers for ***n***th-order regression.
...
### Parameters:
	 ...
	 ***a******n***, or **0** for using the last coefficients generated by **polyfit**.
