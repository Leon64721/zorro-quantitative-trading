...
Calculates
the Frechet distance between the recent part of a data series and a predefined
curve. Returns a percent value equivalent to the similarity between the two curves. This function
can be used for comparing a price curve part with a template, thus detecting cups, zigzags, or similar patterns in the price curve.

### Parameters:


             | **Data**
             | The [series](series.htm) to be compared.
...
- Related blog article:
		  [
		  Pattern recognition with the frechet distance](https://robotwealth.com/pattern-recognition-with-the-frechet-distance/)
