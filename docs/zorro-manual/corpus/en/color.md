...
### Parameters:
             ...
             | **Value**
             | The color position within the range in percent; from **0** for **color1** until **100** for **color4**.


             | **Color1..Color4**
             | The color range, starting with **color1** and ending with **color4**. For 2-color or 3-color ranges, **color3** and **color4** can be omitted. See [Colors](colors.htm) for the color format.
...
### Parameters:
             ...
             | **Scale**
             | The scaling factor in percent, < 100 for reducing the brightness
			and > 100 for increasing it.
...
- **colorScale(Color,110)** increases the
				brightness of **Color** by 10%.

- For putting a color together from RGB values, use the
				expression **(Red<<16)+(Green<<8)+Blue**.
 
