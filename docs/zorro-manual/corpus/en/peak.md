...
Returns the bar offset of the last maximum (**peak**) or minimum (**valley**)
of the **Data** series, or **0** when the series had
no peak or valley within the **TimePeriod**.
...
### Returns:
        ...
        ** true** or bar offset at the peak or valley, **false**
or **0** if no peak and valley was found.
