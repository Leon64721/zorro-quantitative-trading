...
**slope** or with [Min/Max/MinIndex/MaxIndex](transform.htm). 
...
- The **slope** function is used for the [
	Support](ta.htm), [Resistance](ta.htm), and [
	Divergence](ta.htm) indicators.
...
[crossOver](crossover.htm), [crossUnder](crossover.htm),
[rising](rising.htm), [falling](rising.htm),
[peak](peak.htm), [valley](peak.htm), [
peakF](fuzzy.htm), [valleyF](fuzzy.htm), [predict](predict.htm)
