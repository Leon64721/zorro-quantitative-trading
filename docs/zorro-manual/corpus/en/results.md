...
**+8**   -
			consider only open trades
**+16** - consider only closed trades

			**+32**
			- consider only trades of current asset / algo combination
**+64**
			- consider only winning trades
**+128** - consider
			only losing trades
**+256** - consider only long
			trades
...
- Unlike
			[Trade statistics](winloss.htm) that are updated at any
